...
Usage:
  ...
  mcce4_agent_ftpl.py -lig_code EMH                                # Ligand code only (fetches from RCSB)
  mcce4_agent_ftpl.py EMH.pdb -lig_code EMH                       # PDB + ligand code
  mcce4_agent_ftpl.py -lig_code EMH --dry-run --no-llm             # Quick test from RCSB
